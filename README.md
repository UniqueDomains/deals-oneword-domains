...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C958%20rows-8250df">
...
**Public extract:** 8,958 rows · **Live catalog:** 8,957 domains
...
- `deals.csv` — public CSV extract (8,958 rows)
- `deals.json` — public JSON extract (8,958 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,958-row public sample | 8,957 live domains                               |
